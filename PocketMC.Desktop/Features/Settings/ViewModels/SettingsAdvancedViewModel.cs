...
{
    public class SettingsAdvancedViewModel : ViewModelBase
    {
        ...
        public SettingsAdvancedViewModel(string serverDir, ServerConfigurationService configService, Action markDirty)
        {
