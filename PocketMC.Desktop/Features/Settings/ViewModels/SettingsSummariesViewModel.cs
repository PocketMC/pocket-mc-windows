...
/// </summary>
public class SettingsSummariesViewModel : ViewModelBase
{
    ...
    public SettingsSummariesViewModel(string serverDir, SummaryStorageService storageService, IDialogService dialogService)
    {
