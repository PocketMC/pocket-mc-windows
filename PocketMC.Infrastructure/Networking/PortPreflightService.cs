...
public sealed class PortPreflightService
{
    ...
    private static InstanceMetadata CloneMetadata(InstanceMetadata metadata)
    {
        return new InstanceMetadata
        {
            ...
            ScheduledRebootMode = metadata.ScheduledRebootMode,
            ScheduledRebootTime = metadata.ScheduledRebootTime,
            ScheduledRebootIntervalHours = metadata.ScheduledRebootIntervalHours,
            ScheduledRebootWarning = metadata.ScheduledRebootWarning,
            ScheduledRebootWarningSeconds = metadata.ScheduledRebootWarningSeconds,
            LastScheduledRebootTime = metadata.LastScheduledRebootTime,
