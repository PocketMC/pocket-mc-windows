...
public class ServerLaunchConfigurator
{
    ...
    internal Func<int, string, Task<bool>> ConfirmJavaDownloadPrompt { get; set; } = (version, serverName) =>
    {
        // Default: auto-approve. Desktop layer overrides this with a dialog prompt.
