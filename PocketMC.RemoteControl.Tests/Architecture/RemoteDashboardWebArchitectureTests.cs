using PocketMC.RemoteControl.Tests.TestSupport.Utilities;
namespace PocketMC.RemoteControl.Tests.Architecture;

public sealed class RemoteDashboardWebArchitectureTests
{
    [Fact]
