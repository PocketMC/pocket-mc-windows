...
public sealed class ServerConfigurationServiceTests : IDisposable
{
    ...
    public void Load_SeparatesCoreAndAdvancedServerProperties()
    {
        ...
        var service = new ServerConfigurationService(manager, new PocketMC.Infrastructure.Instances.GeyserDetector(new PocketMC.Infrastructure.Marketplace.AddonManifestService()));
