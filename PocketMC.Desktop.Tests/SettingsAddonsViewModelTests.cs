...
public sealed class SettingsAddonsVMTests
{
    ...
    {
        Assert.Equal("", SettingsAddonsViewModel.FormatAddonUpdateWarningText(null!));
        Assert.Equal("", SettingsAddonsViewModel.FormatAddonUpdateWarningText(new List<string>()));
    }
    ...
    public void FormatAddonUpdateWarningText_FormatsListCorrectly()
    {
        ...
        string formatted = SettingsAddonsViewModel.FormatAddonUpdateWarningText(warnings);
    ...
    public void BuildUpdateConfirmationMessage_AppendsWarnings()
    {
        ...
        string message = SettingsAddonsViewModel.BuildUpdateConfirmationMessage("MyMod", "1.0", "2.0", warnings);
    ...
    {
        var warnings = new List<string> { "Warning 1" };
        string message = SettingsAddonsViewModel.BuildReinstallConfirmationMessage("MyMod", "2.0", warnings);
        Assert.Contains("MyMod", message);
    ...
    public void BuildBatchUpdateSummaryMessage_AppendsAllWarnings()
    {
        ...
        string message = SettingsAddonsViewModel.BuildBatchUpdateSummaryMessage(2, 5, updates, warnings);
