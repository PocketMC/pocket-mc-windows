...
public sealed class ServerSettingsProfile
{
    ...
    public static ServerSettingsProfile FromMetadata(InstanceMetadata metadata, bool isGeyserInstalled)
    {
        return new ServerSettingsProfile(metadata.Compatibility.Family, isGeyserInstalled);
    }
}
