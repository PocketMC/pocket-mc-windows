...
public sealed class ServerConfigurationService
{
    ...
    private readonly IGeyserDetector _geyserDetector;

    public ServerConfigurationService(InstanceManager instanceManager, IGeyserDetector geyserDetector)
    {
    ...
    public ServerConfiguration Load(InstanceMetadata metadata, string serverDir)
    {
        ...
        var profile = ServerSettingsProfile.FromMetadata(metadata, _geyserDetector.IsGeyserInstalled(serverDir));
